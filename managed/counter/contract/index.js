...
export class Contract {
  ...
  initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = this._organizerCommitment_0(this._organizerSecret_0(context,
                                                                      partialProofData));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _organizerCommitment_0(secret_0) {
    return this._persistentHash_0([new Uint8Array([113, 117, 105, 101, 116, 99, 111, 117, 110, 116, 58, 111, 114, 103, 97, 110, 105, 122, 101, 114, 58, 118, 49, 0, 0, 0, 0, 0, 0, 0, 0, 0]),
                                   secret_0]);
  }
  _increment_0(context, partialProofData) {
    __compactRuntime.assert(this._equal_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                          ...
                                          this._organizerCommitment_0(this._organizerSecret_0(context,
                                                                                              partialProofData))),
