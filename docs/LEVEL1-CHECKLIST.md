# Rise In Level 1 acceptance record

Source: the Level 1 submission page and its linked `midnight_prompts` guide, read on 19 September 2026 (Asia/Kolkata).

Active period: September Challenge, displayed as 1 September–1 October. The submission is a connected public GitHub repository. Passing/review is decided by Rise In; a submitted state is not the same as an accepted review.
...
Do not mark any runtime or submission item complete solely because its code or workflow exists.
